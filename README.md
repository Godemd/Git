...
В проект добавлены новые функции для работы с данными о банковских операциях, а также обновлена основная логика проекта.

### 2024-06-21:
- Добавлена поддержка расширений файлов `csv` и `xlsx` для функции **`read_data_from_json`** 

### 2024-06-15:
- Были добавлены логи к фунциям: `masks` и `utils` 
...
- **`utils.py`**
    - **`read_data_from_json`**: *Возвращает список словарей из JSON/CSV/XLSX*
